...
#ANTIJS_V2
#cl = LineClient()
cl = LineClient(authToken='EBBC4dUReu3FYtXnjN9b.h43tlEb5HQmu+PaIDhn0cW.jVezf5QYxQy/MmIQt169QatOKYQ5WU6ne6Js/YrhUSQ=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

#ki = LineClient()
ki = LineClient(authToken='EBEoSE7ttIGOdQSiYgUa.FXPdYKzFOQ4pxPWZQmtfMG.v+FX0gxX92U1EotEM54Ynm/+07PujS0NO6mlqdQmO34=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

#kk = LineClient()
kk = LineClient(authToken='EBBC4dUReu3FYtXnjN9b.h43tlEb5HQmu+PaIDhn0cW.jVezf5QYxQy/MmIQt169QatOKYQ5WU6ne6Js/YrhUSQ=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

#kc = LineClient()
kc = LineClient(authToken='EBBC4dUReu3FYtXnjN9b.h43tlEb5HQmu+PaIDhn0cW.jVezf5QYxQy/MmIQt169QatOKYQ5WU6ne6Js/YrhUSQ=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

#sw = LineClient()
sw = LineClient(authToken='EBBC4dUReu3FYtXnjN9b.h43tlEb5HQmu+PaIDhn0cW.jVezf5QYxQy/MmIQt169QatOKYQ5WU6ne6Js/YrhUSQ=')
...
admin = ["u1fd54a385224a0f266e4149912cedc73","u49f833aa6422db25eda1166317cd7789","u0c189d8519a6a6c2adef55336ed725ae"]
staff = ["u1fd54a385224a0f266e4149912cedc73"]
...
wait = {
    ...
    "comment":"Like like & like by Mbing",
            ...
            if Amid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        ki.acceptGroupInvitation(op.param1)
                        ginfo = ki.getGroup(op.param1)
                        ki.sendMessage(op.param1,"Salken All")
            if Bmid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        kk.acceptGroupInvitation(op.param1)
                        ginfo = kk.getGroup(op.param1)
                        kk.sendMessage(op.param1,"Yang Read Jones")
            if Cmid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        kc.acceptGroupInvitation(op.param1)
                        ginfo = kc.getGroup(op.param1)
                        kc.sendMessage(op.param1,"Yang Nyimak Mandul")
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                tz = pytz.timezone("Asia/Jakarta")
                                timeNow = datetime.now(tz=tz)
                                md = "â§ÄPÄ¶ PÅ˜Ã˜Å¤Ä˜ÄŒÅ¤ÃŽÃ˜Å‡â§\n"
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"Creator Bot Mbing") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"â§ÄPÄ¶  bot\n\n"+ma+"\nTotalã€Œ%sã€ Bots" %(str(len(Bots))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to, "â§ÄPÄ¶ Speed respon\n\n - Get Profile\n   %.10f\n - Get Contact\n   %.10f\n - Get Group\n   %.10f" % (get_profile_time/3,get_contact_time/3,get_group_time/3))
